...
const SwipeableListBackup = ({ onPress = () => { }, title = 'Title', fromTo = 'From This to That', statusHeading = 'Status: ', statusMain = 'Unknown', statusMainColor = '#FF9821', LeftSwipeActions = (swipeRef) => { return <></> }, rightSwipeActions = (swipeRef) => { return <></> }, imgURI = null }) => {
