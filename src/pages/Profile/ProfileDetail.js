            ...
            <View style={{
              ...
              <View style={{ flexDirection: 'column', width: '100%', }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                  ...
                  <TouchableOpacity style={{ paddingRight: 10 }} onPress={() => { this.copyToClipboard(this.state.itemObj.empEmail) }}>
              ...
              <View style={{ flexDirection: 'column', width: '100%', }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                  ...
                  <TouchableOpacity style={{ paddingRight: 10 }} onPress={() => { this.copyToClipboard(this.state.itemObj.empMobileNumber) }}>
                    <Image style={{ height: 20, width: 20, resizeMode: 'contain' }} source={require('../../images/copy.png')}></Image>
                  </TouchableOpacity>
                </View>
              </View>
        ...
        <View style={{
          ...
          <View style={{
            ...
            <TouchableOpacity style={styles.btn} onPress={() => this.callAction()}>
              <Image style={{ height: 25, width: 25, resizeMode: 'contain', tintColor: 'white' }} source={require('../../images/phonePlain.png')}></Image>
              <Text  allowFontScaling={false}  style={{ fontSize: 10, fontFamily: Constant.MontserratRegular, color: 'white', marginTop: 5 }}>Call</Text>
            </TouchableOpacity>
            <View style={{ width: 1, height: 25, backgroundColor: 'white' }}></View>
            <TouchableOpacity style={styles.btn} onPress={() => this.emailAction()}>
              <Image style={{ height: 25, width: 25, resizeMode: 'contain', tintColor: 'white' }} source={require('../../images/emailPlain.png')}></Image>
              <Text  allowFontScaling={false}  style={{ fontSize: 10, fontFamily: Constant.MontserratRegular, color: 'white', marginTop: 5 }}>Email</Text>
            </TouchableOpacity>
            <View style={{ width: 1, height: 25, backgroundColor: 'white' }}></View>
            <TouchableOpacity style={styles.btn} onPress={() => this.whatsAppAction()}>
              <Image style={{ height: 25, width: 25, resizeMode: 'contain', tintColor: 'white' }} source={require('../../images/whatsappPlain.png')}></Image>
              <Text  allowFontScaling={false}  style={{ fontSize: 10, fontFamily: Constant.MontserratRegular, color: 'white', marginTop: 5 }}>Whatsapp</Text>
